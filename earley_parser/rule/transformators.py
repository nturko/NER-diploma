...
from earley_parser.visitor import Visitor
from earley_parser.dot import (
    style,
    DotTransformator,
    BLUE,
    ORANGE,
...
from earley_parser.predicates import is_predicate
...
def max_bound(item, count, reverse=False):
    from earley_parser.api import rule, or_
...
def repeatable(item, reverse=False):
    from earley_parser.api import forward, or_, rule
...
def optional(item, reverse=False):
    from earley_parser.api import or_, empty
...
def repeatable_optional(item, reverse_repeatable=False, reverse_optional=False):
    from earley_parser.api import forward, or_, rule, empty
...
class ReplaceExtendedTransformator(RuleTransformator):
    ...
    def visit_MinBoundedRule(self, item):
        ...
        from earley_parser.api import rule
        return rule(*items)
