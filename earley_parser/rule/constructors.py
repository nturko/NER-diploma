...
from earley_parser.compat import string_type
from earley_parser.utils import (
    Record,
    assert_type,
    assert_greater_equals
)
from earley_parser.visitor import TransformatorsComposition
from earley_parser.predicates import Predicate
from earley_parser.relations import Main
...
class Rule(Record):
    ...
    def interpretation(self, item):
        from earley_parser.interpretation import prepare_rule_interpretator
...
class InterpretationRule(WrapperRule):
    ...
    def __init__(self, rule, interpretator):
        from earley_parser.interpretation import Interpretator
...
class RelationRule(WrapperRule):
    ...
    def __init__(self, rule, relation):
        from earley_parser.relations import Relation
...
class ForwardRule(Rule):
    ...
    def define(self, item, *items):
        from earley_parser import rule
