...
from earley_parser.pipelines import PipelineProduction
from earley_parser.interpretation.interpretator import InterpretatorInput
...
class RelationsTransformator(InplaceTreeTransformator):
    def __init__(self):
        from earley_parser.relations.graph import TokenRelationsGraph
...
class DotTreeTransformator(DotTransformator, InplaceTreeTransformator):
    def __init__(self):
        ...
        from earley_parser.relations.graph import RelationsGraph
